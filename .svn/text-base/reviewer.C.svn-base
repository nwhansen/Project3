...
reviewer::reviewer(const reviewer &otherReviewer)
{
	this->id = otherReviewer.id;
	this->misspelled_word_count = otherReviewer.misspelled_word_count;
	this->posts = otherReviewer.posts;
	this->total_helpful_count = otherReviewer.total_helpful_count;
	this->total_nonhelpful_count = otherReviewer.total_nonhelpful_count;
	this->total_word_count = otherReviewer.total_word_count;
}
